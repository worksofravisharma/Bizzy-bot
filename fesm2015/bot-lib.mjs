...
import { SecurityContext, Component, Input, ViewChild, HostListener, NgModule } from '@angular/core';
...
function mergeBizzyBotWidgetConfig(base, patch) {
    if (!patch || !isPlainObject(patch)) {
        return Object.assign(Object.assign({}, base), { theme: Object.assign({}, base.theme), widgets: Object.assign({}, base.widgets) });
    }
    return Object.assign(Object.assign(Object.assign({}, base), patch), { theme: Object.assign(Object.assign({}, base.theme), patch.theme), widgets: Object.assign(Object.assign({}, base.widgets), patch.widgets) });
}
...
class BizzyBotComponent {
    constructor(ngZone, host, http, sanitizer) {
        this.ngZone = ngZone;
        this.host = host;
        this.http = http;
    ...
    get brandIconSrc() {
        var _a;
        const u = (_a = this.widgetConfig.brandIconUrl) === null || _a === void 0 ? void 0 : _a.trim();
        return u || DEFAULT_BRAND_ICON_SRC;
    }
    get fabLogoSrc() {
        var _a;
        return (((_a = this.widgetConfig.fabLogoUrl) === null || _a === void 0 ? void 0 : _a.trim()) ||
    ...
    applyWidgetConfig(initial) {
        ...
        this.widgetConfig = mergeBizzyBotWidgetConfig(BIZZY_BOT_DEFAULT_WIDGET_CONFIG, patch !== null && patch !== void 0 ? patch : undefined);
        this.applyThemeToHost((_a = this.widgetConfig.theme) !== null && _a !== void 0 ? _a : {});
    ...
    syncUiFlags(widgets) {
        const w = widgets !== null && widgets !== void 0 ? widgets : {};
        this.ui = {
    ...
    applyThemeToHost(theme) {
        ...
        const defaults = (_a = BIZZY_BOT_DEFAULT_WIDGET_CONFIG.theme) !== null && _a !== void 0 ? _a : {};
        const keys = new Set([...Object.keys(defaults), ...Object.keys(theme)]);
        for (const key of keys) {
            const value = (_b = theme[key]) !== null && _b !== void 0 ? _b : defaults[key];
            if (value == null || value === '') {
                continue;
            }
    ...
    resetWelcomeMessage() {
        var _a, _b;
        const text = (_b = (_a = this.widgetConfig.welcomeMessage) !== null && _a !== void 0 ? _a : BIZZY_BOT_DEFAULT_WIDGET_CONFIG.welcomeMessage) !== null && _b !== void 0 ? _b : '';
    ...
    getBearerAuthHttpHeaders() {
        ...
        try {
            const t = (_a = sessionStorage
                .getItem(BizzyBotComponent.SESSION_ACCESS_TOKEN_KEY)) === null || _a === void 0 ? void 0 : _a.trim();
            if (t) {
    ...
    setBotFeedback(index, value) {
        ...
        const query = (_b = (_a = msg.feedbackTurn) === null || _a === void 0 ? void 0 : _a.query) !== null && _b !== void 0 ? _b : this.inferFeedbackQueryFromPriorMessages(index);
        const response = (_d = (_c = msg.feedbackTurn) === null || _c === void 0 ? void 0 : _c.response) !== null && _d !== void 0 ? _d : this.botMessageFeedbackResponseText(msg);
        this.http
    ...
    copyBotMessageFromMenu(message) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.copyBotMessage(message);
            this.closeBubbleMenu();
        });
    }
    triggerFileUpload() {
    ...
    fileUploadIconClass(message) {
        var _a, _b, _c, _d;
        const name = (_b = (_a = message.fileUpload) === null || _a === void 0 ? void 0 : _a.fileName) !== null && _b !== void 0 ? _b : '';
        const ext = (_d = (_c = name.split('.').pop()) === null || _c === void 0 ? void 0 : _c.toLowerCase()) !== null && _d !== void 0 ? _d : '';
        if (ext === 'pdf') {
            return 'fa-file-pdf';
        }
    ...
    encodeFileToBase64(file, messageIndex) {
        this.convertFileToDataUrl(file)
            ...
            this.ngZone.run(() => {
                ...
                if (!(msg === null || msg === void 0 ? void 0 : msg.fileUpload) || msg.fileUpload.state === 'error') {
                    return;
                }
                const { mimeType, base64Payload } = BizzyBotComponent.parseDataUrl(dataUrl);
                msg.fileUpload = Object.assign(Object.assign({}, msg.fileUpload), { state: 'done', progress: 100, dataUrl,
                    mimeType,
                    base64Payload });
            ...
            this.ngZone.run(() => {
                this.clearUploadProgressTimers();
                const msg = this.messages[messageIndex];
                if (msg === null || msg === void 0 ? void 0 : msg.fileUpload) {
                    msg.fileUpload = Object.assign(Object.assign({}, msg.fileUpload), { state: 'error', progress: 0 });
                }
                this.scrollToBottom();
            });
        });
    ...
    convertFileToDataUrl(file) {
        return new Promise((resolve, reject) => {
            ...
            reader.onerror = () => { var _a; return reject((_a = reader.error) !== null && _a !== void 0 ? _a : new Error('File read failed')); };
    ...
    static parseDataUrl(dataUrl) {
        ...
        const mimeType = ((_a = meta.split(';')[0]) === null || _a === void 0 ? void 0 : _a.trim()) || 'application/octet-stream';
    ...
    runUploadProgressSimulation(messageIndex) {
        ...
        const tick = () => {
            this.ngZone.run(() => {
                const msg = this.messages[messageIndex];
                if (!(msg === null || msg === void 0 ? void 0 : msg.fileUpload) || msg.fileUpload.state !== 'uploading') {
                    return;
                }
                step += 1;
                const progress = Math.min(maxSimulated, Math.round((step / steps) * maxSimulated));
                msg.fileUpload = Object.assign(Object.assign({}, msg.fileUpload), { progress });
    ...
    messageLinkIntroVisible(message) {
        var _a;
        if (!message.linkUrl || !((_a = message.content) === null || _a === void 0 ? void 0 : _a.trim())) {
            return false;
        }
    ...
    copyBotMessage(message) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const parts = [];
            if (message.linkUrl) {
                if ((_a = message.linkTitle) === null || _a === void 0 ? void 0 : _a.trim()) {
    ...
    fetchAgentReply(userQuery) {
        var _a, _b, _c, _d;
        this.postAgentQuery(userQuery, (_b = (_a = this.lastPayslipAttachment) === null || _a === void 0 ? void 0 : _a.mimeType) !== null && _b !== void 0 ? _b : '', (_d = (_c = this.lastPayslipAttachment) === null || _c === void 0 ? void 0 : _c.base64Payload) !== null && _d !== void 0 ? _d : '');
    }
    /**
    ...
    postAgentQuery(query, payslipMimeType, payslipBase64, feedbackFileLabel) {
        ...
        this.isTyping = true;
        this.scrollToBottom();
        const fileLabel = feedbackFileLabel !== null && feedbackFileLabel !== void 0 ? feedbackFileLabel : (payslipBase64 ? this.findLatestCompletedUploadFileName() : undefined);
    ...
    static buildAgentFeedbackQueryLabel(query, payslipMimeType, payslipBase64, fileDisplayName) {
        ...
        if (payslipBase64 === null || payslipBase64 === void 0 ? void 0 : payslipBase64.trim()) {
            const mime = (payslipMimeType === null || payslipMimeType === void 0 ? void 0 : payslipMimeType.trim()) || 'application/octet-stream';
            const name = (fileDisplayName === null || fileDisplayName === void 0 ? void 0 : fileDisplayName.trim()) || 'document';
    ...
    findLatestCompletedUploadFileName() {
        ...
        for (let j = this.messages.length - 1; j >= 0; j -= 1) {
            ...
            if (((_a = m.fileUpload) === null || _a === void 0 ? void 0 : _a.state) === 'done') {
    ...
    inferFeedbackQueryFromPriorMessages(botMessageIndex) {
        ...
        for (let i = botMessageIndex - 1; i >= 0; i -= 1) {
            ...
            if (((_a = m.fileUpload) === null || _a === void 0 ? void 0 : _a.state) === 'done') {
                ...
                const mt = (_b = m.fileUpload.mimeType) !== null && _b !== void 0 ? _b : 'application/octet-stream';
                parts.unshift(`Attached file: ${fn} (${mt})`);
            }
            const t = (_c = m.content) === null || _c === void 0 ? void 0 : _c.trim();
            if (t) {
                parts.unshift(t);
            }
            if (m.linkUrl) {
     ...
     */
    isLikelyBotHtml(content) {
        var _a;
        const t = (_a = content === null || content === void 0 ? void 0 : content.trim()) !== null && _a !== void 0 ? _a : '';
        if (t.length < 3) {
            return false;
        }
    ...
    sanitizedBotHtml(content) {
        var _a, _b;
        const raw = (_a = content === null || content === void 0 ? void 0 : content.trim()) !== null && _a !== void 0 ? _a : '';
        const cleaned = (_b = this.sanitizer.sanitize(SecurityContext.HTML, raw)) !== null && _b !== void 0 ? _b : '';
        return this.sanitizer.bypassSecurityTrustHtml(cleaned);
    }
    /** Copy / feedback string when content is HTML. */
    messageBodyPlainText(message) {
        var _a, _b;
        const body = (_b = (_a = message.content) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : '';
        if (!body) {
            return '';
        }
     ...
     */
    flushScrollToBottom(smooth = false) {
        var _a;
    ...
    ensureSpeechRecognition() {
        var _a;
        const win = window;
        const RecognitionCtor = (_a = win.SpeechRecognition) !== null && _a !== void 0 ? _a : win.webkitSpeechRecognition;
        if (!RecognitionCtor) {
            return false;
        }
        ...
        this.speechRecognition.onresult = (event) => {
            this.ngZone.run(() => {
                ...
                for (let i = event.resultIndex; i < event.results.length; i += 1) {
                    ...
                    this.speechSessionAccumulated += (_b = (_a = result[0]) === null || _a === void 0 ? void 0 : _a.transcript) !== null && _b !== void 0 ? _b : '';
                }
            });
        };
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.3.0", ngImport: i0, type: BizzyBotComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.NgZone }, { type: i0.ElementRef }, { type: i1.HttpClient }, { type: i2.DomSanitizer }]; }, propDecorators: { config: [{
                type: Input
            }], chatContainer: [{
                type: ViewChild,
                args: ['chatContainer']
